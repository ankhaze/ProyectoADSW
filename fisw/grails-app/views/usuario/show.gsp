	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<sec:ifAllGranted roles='ROLE_ADMIN' or = 'ROLE_DIREC'> <%-- Aqui solo dejo q los admin o directores puedan ver estas opciones--%>
			...
			<g:form url="[resource:usuarioInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					...
					<sec:ifAllGranted roles='ROLE_USER'>
						<g:link class="edit" action="editPerfil" ><g:message code="default.button.edit.label" default="Edit" /></g:link>
					</sec:ifAllGranted>
				</fieldset>
			</g:form>
		</div>
